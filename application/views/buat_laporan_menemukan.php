...
<section class="content">
    <div class="animsition">
        ...
        <h2 style="margin-top:0px">Buat Laporan Menemukan</h2>
        <div class="box">
            <div class="box-body">
                <?php echo form_open_multipart('Buat_Laporan_menemukan/upload');?>
                <!-- <form action="<?php echo base_url('index.php/Buat_Laporan_menemukan/tambah') ?>" method="post"> -->
                ...
                <div class="form-group">
                    <label for="lokasi">Lokasi Menemukan <?php echo form_error('lokasi') ?></label>
